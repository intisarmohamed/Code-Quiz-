const movieQuestions = [
  {
    title:
      "Which Bond villain used a knife attached to her shoe to take down her victims?",
    options: ["Xenia Onatopp", "Rosa Klebb", "Fiona Volpe", "Irma Bunt"],
    correctOption: "Rosa Klebb",
  },
  {
    title:
      "Which Bond villain suffered from a brain condition that made him immune to pain?",
    options: ["Renard", "Tang Ling Zao", "Le Chiffre", "Hugo Drax"],
    correctOption: "Renard",
  },
  {
    title:
      "Who was the first villainous Bond girl? She is one of the main antagonists in the movie.?",
    options: ["Elektra King", "Fiona Volpe", "Helga Brandt", "Andrea Anders"],
    correctOption: "Fiona Volpe",
  },
];
